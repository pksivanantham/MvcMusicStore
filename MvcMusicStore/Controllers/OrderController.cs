...
namespace MvcMusicStore.Controllers
{
    public class OrderController : Controller
    {
        ...
        {
            var modelStatevalid1 = ModelState["FirstName"].Errors.Count > 0;
            var modelStateVaidByProp = ModelState.IsValidField("FirstName");
            var result=TryUpdateModel(order);
